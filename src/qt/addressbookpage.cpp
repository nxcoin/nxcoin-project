    ...
    tab(tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your nxcoin addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ...
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your nxcoin addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you."));
        ...
        break;
    case ZerocoinTab:
        ui->labelExplanation->setText(tr("These are your private coins from mint nextcoin operation, You can perform spend nextcoin operation to redeem nxcoin back from Nextcoin."));
        ui->deleteAddress->setVisible(false);
        ui->signMessage->setVisible(false);
...
void AddressBookPage::on_zerocoinMintButton_clicked()
{
    ...
    if(!model->zerocoinMint(stringError)){
        ...
        QMessageBox::critical(this, tr("Error"),
            tr("You cannot mint nextcoin because %1").arg(t),
...
void AddressBookPage::on_zerocoinSpendButton_clicked(){
    ...
    if(!model->zerocoinSpend(stringError)){
        ...
        QMessageBox::critical(this, tr("Error"),
            tr("You cannot spend nextcoin because %1").arg(t),
            QMessageBox::Ok, QMessageBox::Ok);
    }
}
